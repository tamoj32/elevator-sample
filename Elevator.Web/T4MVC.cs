...
{
    public static Elevator.Web.Controllers.HomeController Home = new Elevator.Web.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string el_elevator_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/el.elevator.min.js") ? Url("el.elevator.min.js") : Url("el.elevator.js");
        public static readonly string el_elevator_vm_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/el.elevator.vm.min.js") ? Url("el.elevator.vm.min.js") : Url("el.elevator.vm.js");
        public static readonly string el_floor_vm_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/el.floor.vm.min.js") ? Url("el.floor.vm.min.js") : Url("el.floor.vm.js");
        public static readonly string el_hub_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/el.hub.min.js") ? Url("el.hub.min.js") : Url("el.hub.js");
    ...
    public static class Content {
        ...
        public static class images {
            ...
            public static readonly string _1_gif = Url("1.gif");
            public static readonly string _2_gif = Url("2.gif");
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public const string el_elevator_js = "~/Scripts/el.elevator.js"; 
                public const string el_elevator_vm_js = "~/Scripts/el.elevator.vm.js"; 
                public const string el_floor_vm_js = "~/Scripts/el.floor.vm.js"; 
                public const string el_hub_js = "~/Scripts/el.hub.js"; 
